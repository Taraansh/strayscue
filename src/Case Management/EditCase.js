...
export default function EditCase() {
  ...
  const {
    ...
    getAllVets,
    handleDownloadImage,
    handleAnimalPictureDeleteButton,
    handleFeedingRecordImageDeleteButton,
    handleBloodReportImageDeleteButton,
    handleMedicalPrescriptionImageDeleteButton,
    handleTreatmentRecordImageDeleteButton,
    handleOrganImageDeleteButton,
    handlePopPicturesDeleteButton,
    handleReleasePicturesDeleteButton,
  ...
  const [isConsentFormImageDeleted, setIsConsentFormImageDeleted] =
    useState(false);
  ...
  const [deletedFeedingRecordImageIds, setDeletedFeedingRecordImageIds] =
    useState([]);
  ...
  const [medicalPrescriptionImagePreview, setMedicalPrescriptionImagePreview] =
    useState([]);
  const [medicalPrescriptionImageDate, setMedicalPrescriptionImageDate] =
    useState([]);
  ...
  const [
    deletedMedicalPrescriptionImageIds,
    setDeletedMedicalPrescriptionImageIds,
  ] = useState([]);
  const [deletedTreatmentRecordImageIds, setDeletedTreatmentRecordImageIds] =
    useState([]);
  ...
  const handleUpdateReportingDetails = async (e) => {
    ...
    if (consentFormImageFile) {
      formData.append(
        "consentFormImage",
        consentFormImageFile ? consentFormImageFile : null
      );
    } else if (isFrontImageDeleted) {
      ...
      formData.append(
        "consentFormImage",
        path.state.data.reportingdetail?.consentFormImage
      );
    }
    ...
    formData.append(
      ...
      reporterContact
        ? reporterContact
        : path.state.data.reportingdetail?.reporterContact
    );
    formData.append(
      "reporterAltContact",
      reporterAltContact
        ? reporterAltContact
          ? reporterAltContact
          : ""
        : path.state.data.reportingdetail?.reporterAltContact
    );
    formData.append(
      "reporterEmail",
      reporterEmail
        ? reporterEmail
          ? reporterEmail
          : ""
        : path.state.data.reportingdetail?.reporterEmail
    );
    formData.append(
      "location",
      location ? location : path.state.data.reportingdetail?.location
    );
    formData.append(
      "pincode",
      pincode ? pincode : path.state.data.reportingdetail?.pincode
    );
    formData.append(
      "landmark",
      landmark ? landmark : path.state.data.reportingdetail?.landmark
    );
    formData.append(
      "reportedDate",
      reportedDate
        ? reportedDate
          ? reportedDate
          : "1111-11-11"
        : path.state.data.reportingdetail?.reportedDate
        ? path.state.data.reportingdetail?.reportedDate
        : "1111-11-11"
    );
    formData.append(
      ...
      reportedTime
        ? reportedTime
          ? reportedTime
          : "11:11:11"
        : path.state.data.reportingdetail?.reportedTime
        ? path.state.data.reportingdetail?.reportedTime
        : "11:11:11"
    );
    formData.append(
      ...
      pickupDate
        ? pickupDate
          ? pickupDate
          : "1111-11-11"
        : path.state.data.reportingdetail?.pickupDate
        ? path.state.data.reportingdetail?.pickupDate
        : "1111-11-11"
    );
    formData.append(
      ...
      pickupTime
        ? pickupTime
          ? pickupTime
          : "11:11:11"
        : path.state.data.reportingdetail?.pickupTime
        ? path.state.data.reportingdetail?.pickupTime
        : "11:11:11"
    );
  ...
  const handleUpdateAnimalDetails = async (e) => {
    ...
    if (
      (reporterName || path.state.data.reportingdetail?.reporterName) &&
      (reporterContact || path.state.data.reportingdetail?.reporterContact) &&
      (location || path.state.data.reportingdetail?.location) &&
      (pincode || path.state.data.reportingdetail?.pincode) &&
      (location || path.state.data.reportingdetail?.landmark)
    ) {
      const formData = new FormData();
      formData.append(
        "animalSpecies",
        animalSpecies
          ? animalSpecies
          : path.state.data.animaldetail?.animalSpecies
      );
      formData.append(
        "animalBreed",
        animalBreed ? animalBreed : path.state.data.animaldetail?.animalBreed
      );
      formData.append(
        "animalAge",
        animalAge ? animalAge : path.state.data.animaldetail?.animalAge
      );
      formData.append(
        "animalTemperament",
        animalAge ? animalTemperament : path.state.data.animaldetail?.animalAge
      );
      formData.append(
        "animalGender",
        animalGender ? animalGender : path.state.data.animaldetail?.animalGender
      );
      formData.append(
        "animalPregnant",
        animalPregnant
          ? animalPregnant
          : path.state.data.animaldetail?.animalPregnant
      );
      formData.append(
        "animalMarking",
        animalMarking
          ? animalMarking
          : path.state.data.animaldetail?.animalMarking
      );
      formData.append(
        "animalColor",
        animalColor ? animalColor : path.state.data.animaldetail?.animalColor
      );
      formData.append(
        "animalCatchable",
        animalCatchable
          ? animalCatchable
          : path.state.data.animaldetail?.animalCatchable
      );
      formData.append(
        "animalWeight",
        animalWeight ? animalWeight : path.state.data.animaldetail?.animalWeight
      );
      formData.append(
        "admissionReason",
        admissionReason
          ? admissionReason
          : path.state.data.animaldetail?.admissionReason
      );
  ...
  const handleUpdateMedicalDetails = async (e) => {
    ...
    if (
      ...
      formData.append(
        ...
        medicalHistory
          ? medicalHistory
          : path.state.data.medicaldetail?.medicalHistory
      );
      formData.append(
        "vaccinationStatus",
        vaccinationStatus
          ? vaccinationStatus
          : path.state.data.medicaldetail?.vaccinationStatus
      );
      formData.append(
        "dewormed",
        dewormed ? dewormed : path.state.data.medicaldetail?.dewormed
      );
      formData.append(
        "fitForSurgery",
        fitForSurgery
          ? fitForSurgery
          : path.state.data.medicaldetail?.fitForSurgery
      );
      formData.append(
        "otherDetails",
        otherDetails
          ? otherDetails
          : path.state.data.medicaldetail?.otherDetails
      );
      formData.append(
        "admissionDate",
        admissionDate
          ? admissionDate
            ? admissionDate
            : "1111-11-11"
          : path.state.data.medicaldetail?.admissionDate
          ? path.state.data.medicaldetail?.admissionDate
          : "1111-11-11"
      );

      formData.append(
        "bloodReportImageDate",
        bloodReportImageDate ? bloodReportImageDate : "1111-11-11"
      );
  ...
  const handleUpdatePostOperationDetails = async (e) => {
    ...
    if (
      ...
      formData.append(
        ...
        popComment
          ? popComment
          : path.state.data.postoperationdetail?.popComment
      );
      formData.append(
        "popFacility",
        popFacility
          ? popFacility
          : path.state.data.postoperationdetail?.popFacility
      );
      formData.append(
        "popExpectedDays",
        popExpectedDays
          ? popExpectedDays
          : path.state.data.postoperationdetail?.popExpectedDays
      );
      formData.append(
        "popStartDate",
        popStartDate
          ? popStartDate
            ? popStartDate
            : "1111-11-11"
          : path.state.data.postoperationdetail?.popStartDate
          ? path.state.data.postoperationdetail?.popStartDate
          : "1111-11-11"
      );
      formData.append(
        ...
        popEndDate
          ? popEndDate
            ? popEndDate
            : "1111-11-11"
          : path.state.data.postoperationdetail?.popEndDate
          ? path.state.data.postoperationdetail?.popEndDate
          : "1111-11-11"
      );
      formData.append(
        ...
        releaseDate
          ? releaseDate
            ? releaseDate
            : "1111-11-11"
          : path.state.data.postoperationdetail?.releaseDate
          ? path.state.data.postoperationdetail?.releaseDate
          : "1111-11-11"
      );
      formData.append(
        ...
        euthanized
          ? euthanized
          : path.state.data.postoperationdetail?.euthanized
      );
      formData.append(
        "comments",
        comments ? comments : path.state.data.postoperationdetail?.comments
      );
  ...
  const handleReporterSelection = (e) => {
    ...
    const selectedReporter = allReporters.find(
      (reporter) => reporter.reported_name === selectedReporterName
    );
                        ...
                        <div className="mb-3">
                          ...
                          >
                            ...
                            {allReporters.map((data, index) => {
                              return (
                                <option key={index} value={data.reported_name}>
                                  {data.reported_name}
                                </option>
                              );
                            })}
                      ...
                      <form onSubmit={handleUpdateReportingDetails}>
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <input
                                ...
                                defaultValue={
                                  reporterName ||
                                  (path.state.data.reportingdetail
                                    ?.reporterName === "null"
                                    ? ""
                                    : path.state.data.reportingdetail
                                        ?.reporterName)
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <input
                                ...
                                defaultValue={
                                  path.state.data.reportingdetail?.landmark ===
                                  "null"
                                    ? ""
                                    : path.state.data.reportingdetail?.landmark
                                }
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <input
                                ...
                                required
                                defaultValue={
                                  path.state.data.reportingdetail?.pincode ===
                                  "null"
                                    ? ""
                                    : path.state.data.reportingdetail?.pincode
                                }
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <input
                                ...
                                required
                                defaultValue={
                                  path.state.data.reportingdetail?.location ===
                                  "null"
                                    ? ""
                                    : path.state.data.reportingdetail?.location
                                }
                        ...
                        <div className="row">
                            ...
                            {!isFrontImageDeleted ? (
                              path.state.data.reportingdetail?.frontImage ? (
                                <div>
                                  ...
                                  <div className="my-2">
                                    <button
                                      onClick={handleDeleteSavedFrontImage}
                                      className="btn"
                                      style={{
                                        background: "#ffffff",
                                    ...
                                    <button
                                      ...
                                      onClick={(e) => {
                                        ...
                                        setOpenedImage(
                                          `${websiteUrl}${path.state.data.reportingdetail?.frontImage}`
                                        );
                                      }}
                                    >
                                      Open
                          ...
                          <div className="col">
                            ...
                            {!isBackImageDeleted ? (
                              path.state.data.reportingdetail?.backImage ? (
                                <div>
                                  <h6>Preview:</h6>
                                  <img
                                  ...
                                  <div className="my-2">
                                    <button
                                      onClick={handleDeleteSavedBackImage}
                                      className="btn"
                                      style={{
                                        background: "#ffffff",
                                        border: "1px solid grey",
                                    ...
                                    <button
                                      ...
                                      onClick={(e) => {
                                        e.preventDefault(); // Prevent default form submission
                                        setOpenedImage(
                                          `${websiteUrl}${path.state.data.reportingdetail?.backImage}`
                                        );
                                      }}
                                    >
                                      Open
                          ...
                          {!isConsentFormImageDeleted ? (
                            path.state.data.reportingdetail
                              ...
                              <div>
                                ...
                                <div className="my-2">
                                  <button
                                    onClick={handleDeleteSavedConsentFormImage}
                                    className="btn"
                                    style={{
                                      background: "#ffffff",
                                      border: "1px solid grey",
                                  ...
                                  <button
                                    ...
                                    onClick={(e) => {
                                      e.preventDefault(); // Prevent default form submission
                                      setOpenedImage(
                                        `${websiteUrl}${path.state.data.reportingdetail?.consentFormImage}`
                                      );
                                    }}
                                  >
                                    Open
                              ...
                              consentFormImagePreview && (
                                <div>
                                  ...
                                  <div className="my-2">
                                    <button
                                      onClick={handleDeleteConsentFormImage}
                                      className="btn"
                                      style={{
                                        background: "#ffffff",
                                        border: "1px solid grey",
                  ...
                  <>
                    <div className="my-3">
                      ...
                      <form onSubmit={handleUpdateAnimalDetails}>
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <select
                                ...
                                name="animalBreed"
                                defaultValue={
                                  path.state.data.animaldetail?.animalBreed ||
                                  ""
                                }
                                onChange={(e) => {
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <select
                                ...
                                name="animalAge"
                                defaultValue={
                                  path.state.data.animaldetail?.animalAge || ""
                                }
                                onChange={(e) => {
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <select
                                ...
                                name="animalGender"
                                defaultValue={
                                  path.state.data.animaldetail?.animalGender ||
                                  ""
                                }
                                onChange={(e) => {
                        ...
                        <div className="row form-1">
                          ...
                          <div className="form-group col mb-3">
                            ...
                            <input
                              ...
                              defaultValue={
                                path.state.data.animaldetail?.animalColor ===
                                "null"
                                  ? ""
                                  : path.state.data.animaldetail?.animalColor
                              }
                        ...
                        <div className="row form-1">
                          <div className="form-group col mb-3">
                            ...
                            <input
                              ...
                              defaultValue={
                                path.state.data.animaldetail?.animalWeight ===
                                "null"
                                  ? ""
                                  : path.state.data.animaldetail?.animalWeight
                              }
                                ...
                                <div key={index} className="my-1">
                                  ...
                                  <div className="my-2">
                                    <button
                                      ...
                                      onClick={(e) =>
                                        handleDeleteAnimalPicture(e, index)
                                      }
                                    >
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        {path.state.data.animaldetail?.animalPictures.length >
                          0 && (
                          <div>
                            ...
                            >
                              {path.state.data.animaldetail.animalPictures.map(
                                (data, index) =>
                                  // Check if the image ID is not in the deletedAnimalPictureIds array
                                  // If not, display the image and the delete button
                                  !deletedAnimalPictureIds.includes(
                                    data.id
                                  ) && (
                                    <div key={index} className="my-1">
                                      <p>Image {index + 1}:</p>
                                      <img
                                        src={`${websiteUrl}${data.animalPictures}`}
                                        alt="Animal Pictures Preview"
                                        height="100px"
                                        width="100px"
                                      />
                                      ...
                                      >
                                        <button
                                          ...
                                          onClick={(e) =>
                                            handleDeleteSavedAnimalPicture(
                                              e,
                                              data.id
                                            )
                                          }
                                        ...
                                        <button
                                          ...
                                          onClick={(e) => {
                                            e.preventDefault(); // Prevent default form submission
                                            setOpenedImage(
                                              `${websiteUrl}${data.animalPictures}`
                                            );
                                          }}
                                        >
                                          Open
                                      ...
                                      <div className=" my-3">
                                        <label
                                          className="form-label"
                                          htmlFor="animal_picture_upload_date"
                                        >
                                          Upload Date:
                                        </label>
                                        <input
                                          ...
                                          disabled
                                          value={
                                            data.animal_picture_upload_date
                                          }
                                        />
                                      </div>
                                    </div>
                      ...
                      <form onSubmit={handleUpdateMedicalDetails}>
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <select
                                ...
                                name="dewormed"
                                defaultValue={
                                  path.state.data.medicaldetail?.dewormed || ""
                                }
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <select
                                ...
                                onChange={(e) =>
                                  setFitForSurgery(e.target.value)
                                }
                              >
                                <option value="">Choose</option>
                                <option value="Yes">Yes</option>
                        ...
                        <div style={{ overflow: "auto" }}>
                          <table className="table table-bordered">
                            ...
                            <tbody>
                              {path.state.data.medicaldetail?.bloodReportImage
                                .length > 0 && (
                                <>
                                  {Object.entries(
                                    groupBloodReportImagesByDate(
                                      path.state.data.medicaldetail
                                        ?.bloodReportImage
                                    )
                                  ).map(([date, images], index) => (
                                      ...
                                      <tr>
                                        <td>
                                          ...
                                          >
                                            {images.map(
                                              (data, imageIndex) =>
                                                !deletedBloodReportImageIds.includes(
                                                  data.id
                                                ) && // Check if the image id is not in the deleted ids array
                                                data.bloodReportImage && (
                                                  <div key={imageIndex}>
                                                    <img
                                                      src={`${websiteUrl}${data.bloodReportImage}`}
                                                    ...
                                                    <div className="my-2">
                                                      <button
                                                        ...
                                                        onClick={(e) =>
                                                          handleDeleteSavedBloodReportImage(
                                                            e,
                                                            data.id
                                                          )
                                                        }
                                                      ...
                                                      <button
                                                        ...
                                                        onClick={(e) => {
                                                          e.preventDefault(); // Prevent default form submission
                                                          setOpenedImage(
                                                            `${websiteUrl}${data.bloodReportImage}`
                                                          );
                                                        }}
                                                      >
                                                        Open
                                        ...
                                        ) && ( // Check if at least one image is not deleted
                                          <td>
                                            <input
                                              className="form-control"
                                              type="date"
                              ...
                              <tr>
                                <td>
                                  ...
                                  >
                                    {bloodReportImagePreview.length > 0 &&
                                      bloodReportImagePreview.map(
                                        (preview, index) => (
                                          <div key={index}>
                                            <div className="my-2">
                                              <img
                                ...
                                <td>
                                  <input
                                    ...
                                    onChange={(e) =>
                                      setBloodReportImageDate(e.target.value)
                                    }
                                  />
                                </td>
                              </tr>
                                  ...
                                  <div key={index} className="my-1">
                                    ...
                                    <div className="my-2">
                                      <button
                                        ...
                                        onClick={(e) => {
                                          handleDeleteFeedingRecordImage(
                                            e,
                                            index
                                          );
                                        }}
                        ...
                        {path.state.data.medicaldetail?.feedingRecordImage
                          .length > 0 && (
                          <div>
                            <h6>Preview of Saved Images:</h6>
                            <div
                            ...
                            >
                              {path.state.data.medicaldetail?.feedingRecordImage.map(
                                (data, index) =>
                                  // Check if the image ID is not in the deletedFeedingRecordImageIds array
                                  // If not, display the image and the delete button
                                  !deletedFeedingRecordImageIds.includes(
                                    data.id
                                  ) && (
                                    <div key={index} className="my-1">
                                      <p>Image {index + 1}:</p>
                                      <img
                                        src={`${websiteUrl}${data.feedingRecordImage}`}
                                        alt="Feeding Record Preview"
                                        height="100px"
                                        width="100px"
                                      />
                                      ...
                                      >
                                        <button
                                          ...
                                          onClick={(e) =>
                                            handleDeleteSavedFeedingRecordImage(
                                              e,
                                              data.id
                                            )
                                          }
                                        ...
                                        <button
                                          ...
                                          onClick={(e) => {
                                            e.preventDefault(); // Prevent default form submission
                                            setOpenedImage(
                                              `${websiteUrl}${data.feedingRecordImage}`
                                            );
                                          }}
                                        >
                                          Open
                                      ...
                                      <div className=" my-3">
                                        <label
                                          className="form-label"
                                          htmlFor="feeding_record_image_upload_date"
                                        >
                                          Upload Date:
                                        </label>
                                        <input
                                          className="my-0 form-control"
                                          id="feeding_record_image_upload_date"
                                          name="feeding_record_image_upload_date"
                                          type="date"
                                          readOnly
                                          disabled
                                          value={
                                            data.feeding_record_image_upload_date
                                          }
                                        />
                                      </div>
                                    </div>
                        ...
                        <div className="mb-3">
                          ...
                          >
                            ...
                            {allVets.map((data, index) => {
                              return (
                                <option key={index} value={data.vet_name}>
                                  {data.vet_name}
                                </option>
                              );
                            })}
                      ...
                      <form onSubmit={handleUpdateOperationDetails}>
                          ...
                          <div className="col">
                            <div className="form-group mb-3">
                              ...
                              <input
                                ...
                                type="date"
                                defaultValue={
                                  path.state.data.operationdetail?.operationDate
                                    ? path.state.data.operationdetail
                                        ?.operationDate === "1111-11-11"
                                      ? ""
                                      : path.state.data.operationdetail
                                          ?.operationDate
                                    : ""
                        ...
                        <div className="row form-1">
                          ...
                          <div className="col mb-3">
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setOperationOutcome(e.target.value)
                              }
                            >
                        ...
                        <div style={{ overflow: "auto" }}>
                          <table className="table table-bordered">
                            ...
                            <tbody>
                              {path.state.data.operationdetail
                                ?.medicalPrescriptionImage.length > 0 && (
                                <>
                                  {Object.entries(
                                    groupMedicalPrescriptionImagesByDate(
                                      path.state.data.operationdetail
                                        ?.medicalPrescriptionImage
                                    )
                                  ).map(([date, images], index) => (
                                      ...
                                      <tr>
                                        <td>
                                          ...
                                          >
                                            {images.map(
                                              (data, imageIndex) =>
                                                !deletedMedicalPrescriptionImageIds.includes(
                                                  data.id
                                                ) &&
                                                data.medicalPrescriptionImage && (
                                                  <div key={imageIndex}>
                                                    <img
                                                      src={`${websiteUrl}${data.medicalPrescriptionImage}`}
                                                    ...
                                                    <div className="my-2">
                                                      <button
                                                        ...
                                                        onClick={(e) =>
                                                          handleDeleteSavedMedicalPrescriptionImage(
                                                            e,
                                                            data.id
                                                          )
                                                        }
                                                      ...
                                                      <button
                                                        ...
                                                        onClick={(e) => {
                                                          e.preventDefault(); // Prevent default form submission
                                                          setOpenedImage(
                                                            `${websiteUrl}${data.medicalPrescriptionImage}`
                                                          );
                                                        }}
                                                      >
                                                        Open
                              ...
                              <tr>
                                <td>
                                  ...
                                  >
                                    {medicalPrescriptionImagePreview.length >
                                      0 &&
                                      medicalPrescriptionImagePreview.map(
                                        (preview, index) => (
                                          <div key={index}>
                                            <div className="my-2">
                                              <img
                                              ...
                                              <div className="my-2">
                                                <button
                                                  ...
                                                  onClick={(e) => {
                                                    handleDeleteMedicalPrescriptionImage(
                                                      e,
                                                      index
                                                    );
                                                  }}
                                ...
                                <td>
                                  <input
                                    ...
                                    required={
                                      medicalPrescriptionImagePreview.length > 0
                                        ? true
                                        : false
                                    }
                                    onChange={(e) =>
                                      setMedicalPrescriptionImageDate(
                                        e.target.value
                                      )
                                    }
                                  />
                        ...
                        {treatmentRecordImagePreview.length > 0 && (
                          <div>
                            ...
                            >
                              {treatmentRecordImagePreview.map(
                                (preview, index) => {
                                  return (
                                    <div key={index} className="my-1">
                                      <img
                                        src={preview}
                                        alt="Treatment Record Preview"
                                        height="100px"
                                        width="100px"
                                      />
                                      <div className="my-2">
                                        <button
                                          ...
                                          onClick={(e) =>
                                            handleDeleteTreatmentRecordImage(
                                              e,
                                              index
                                            )
                                          }
                        ...
                        {path.state.data.operationdetail?.treatmentRecordImage
                          .length > 0 && (
                          <div>
                            <h6>Preview of Saved Images:</h6>
                            <div
                            ...
                            >
                              {path.state.data.operationdetail.treatmentRecordImage.map(
                                (data, index) => {
                                  // Check if the image ID is not in the deletedTreatmentRecordImageIds array
                                  // If not, display the image and the delete button
                                  return (
                                    !deletedTreatmentRecordImageIds.includes(
                                      data.id
                                    ) && (
                                      <div key={index} className="my-1">
                                        <p>Image {index + 1}:</p>
                                        <img
                                          src={`${websiteUrl}${data.treatmentRecordImage}`}
                                          alt="Treatment Record Preview"
                                          height="100px"
                                          width="100px"
                                        />
                                        ...
                                        >
                                          <button
                                            ...
                                            onClick={(e) =>
                                              handleDeleteSavedTreatmentRecordImage(
                                                e,
                                                data.id
                                              )
                                            }
                                          ...
                                          <button
                                            ...
                                            onClick={(e) => {
                                              e.preventDefault(); // Prevent default form submission
                                              setOpenedImage(
                                                `${websiteUrl}${data.treatmentRecordImage}`
                                              );
                                            }}
                                          >
                                            Open
                                        ...
                                        <div className=" my-3">
                                          <label
                                            className="form-label"
                                            htmlFor="treatment_record_image_upload_date"
                                          >
                                            Upload Date:
                                          </label>
                                          <input
                                            ...
                                            disabled
                                            value={
                                              data.treatment_record_image_upload_date
                                            }
                                          />
                                        </div>
                                      </div>
                                  ...
                                  <div key={index} className="my-1">
                                    ...
                                    <div className="my-2">
                                      <button
                                        ...
                                        onClick={(e) =>
                                          handleDeleteOrganImage(e, index)
                                        }
                                      >
                                        <svg
                                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        {path.state.data.operationdetail?.organImage.length >
                          0 && (
                          <div>
                            <h6>Preview of Saved Images:</h6>
                            <div
                            ...
                            >
                              {path.state.data.operationdetail?.organImage.map(
                                (data, index) => {
                                  // Check if the image ID is not in the deletedOrganImageIds array
                                  // If not, display the image and the delete button
                                  return (
                                    !deletedOrganImageIds.includes(data.id) && (
                                      <div key={index} className="my-1">
                                        <p>Image {index + 1}:</p>
                                        <img
                                          src={`${websiteUrl}${data.organImage}`}
                                          alt="Animal Pictures Preview"
                                          height="100px"
                                          width="100px"
                                        />
                                        ...
                                        <div className=" my-3">
                                          <label
                                            className="form-label"
                                            htmlFor="organ_image_upload_date"
                                          >
                                            Upload Date:
                                          </label>
                                          <input
                  ...
                  <>
                    <div className="my-3">
                      ...
                      <form onSubmit={handleUpdatePostOperationDetails}>
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <input
                                ...
                                id="popComment"
                                defaultValue={
                                  path.state.data.postoperationdetail
                                    ?.popComment === "null"
                                    ? ""
                                    : path.state.data.postoperationdetail
                                        ?.popComment
                          ...
                          <div className="col">
                            <div className="mb-3">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setPopExpectedDays(e.target.value)
                                }
                              />
                            </div>
                          </div>
                                ...
                                <div key={index} className="my-1">
                                  ...
                                  <div className="my-2">
                                    <button
                                      ...
                                      onClick={(e) =>
                                        handleDeletePopPictures(e, index)
                                      }
                                    >
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        {path.state.data.postoperationdetail?.popPictures
                          .length > 0 && (
                          <div>
                            <h6>Preview of Saved Images:</h6>
                            <div
                            ...
                            >
                              {path.state.data.postoperationdetail.popPictures.map(
                                (data, index) =>
                                  ...
                                  !deletedPopPicturesIds.includes(data.id) && (
                                    <div key={index} className="my-1">
                                      <p>Image {index + 1}:</p>
                                      <img
                                        src={`${websiteUrl}${data.popPictures}`}
                                        alt="Post Operation Pictures Preview"
                                        height="100px"
                                        width="100px"
                                      />
                                      ...
                                      <div className=" my-3">
                                        <label
                                          className="form-label"
                                          htmlFor="pop_pictures_upload_date"
                                        >
                                          Upload Date:
                                        </label>
                                        <input
                                ...
                                <div key={index} className="my-1">
                                  ...
                                  <div className="my-2">
                                    <button
                                      ...
                                      onClick={(e) =>
                                        handleDeleteReleasePictures(e, index)
                                      }
                                    >
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        {path.state.data.postoperationdetail?.releasePictures
                          .length > 0 && (
                          <div>
                            <h6>Preview of Saved Images:</h6>
                            <div
                            ...
                            >
                              {path.state.data.postoperationdetail.releasePictures.map(
                                (data, index) =>
                                  // Check if the image ID is not in the deletedReleasePicturesIds array
                                  // If not, display the image and the delete button
                                  !deletedReleasePicturesIds.includes(
                                    data.id
                                  ) && (
                                    <div key={index} className="my-1">
                                      <p>Image {index + 1}:</p>
                                      <img
                                        src={`${websiteUrl}${data.releasePictures}`}
                                        alt="Release Pictures Preview"
                                        height="100px"
                                        width="100px"
                                      />
                                      ...
                                      >
                                        <button
                                          ...
                                          onClick={(e) =>
                                            handleDeleteSavedReleasePictures(
                                              e,
                                              data.id
                                            )
                                          }
                                        ...
                                        <button
                                          ...
                                          onClick={(e) => {
                                            e.preventDefault(); // Prevent default form submission
                                            setOpenedImage(
                                              `${websiteUrl}${data.releasePictures}`
                                            );
                                          }}
                                        >
                                          Open
                                      ...
                                      <div className=" my-3">
                                        <label
                                          className="form-label"
                                          htmlFor="release_pictures_upload_date"
                                        >
                                          Upload Date:
                                        </label>
                                        <input
                                          ...
                                          disabled
                                          value={
                                            data.release_pictures_upload_date
                                          }
                                        />
                                      </div>
                                    </div>
