...
const AddUser = () => {
  ...
  const stored_type_of_user_in_ngo = localStorage.getItem("type_of_user_in_ngo");
  ...
  let addNewNgoUser = async (e) => {
    ...
    if (isSuperUser === "true"){
      ngo_linked_with_this_user_value = ngo_linked_with_this_user ? ngo_linked_with_this_user : null
    } else if( stored_type_of_user_in_ngo ==="Founder" || stored_type_of_user_in_ngo ==="Manager") 
    {
  ...
  return ((isSuperUser === "true" || stored_type_of_user_in_ngo ==="Founder" || stored_type_of_user_in_ngo ==="Manager") && user) && (
    <div
      style={{
        display: "flex",
